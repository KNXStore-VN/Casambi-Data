...
content_version: "1.0"
source_of_truth: "knxstore.vn product page + olfer.com datasheet"
...
Thiết bị hỗ trợ đầy đủ các chế độ điều khiển DALI: Broadcast, Short Address, Group Address, DT6 (dimming cơ bản), DT8 (màu sắc nâng cao), Tunable White, RGB, RGBW, XY. Profile mặc định là DALI Lin\* Broadcast (ID 33477) — phù hợp với hầu hết ứng dụng dimming đơn giản. Xem chi tiết tại file `cbu-da-1p-fixture-profiles.md`.
...
- Cần điều khiển hơn 50 driver trên 1 network → nâng lên SAL-1016 (16 địa chỉ) hoặc SAL-1032 (32 địa chỉ DALI master).
...
> 📄 Hướng dẫn đầy đủ: [olfer.com/olfer-cbu-da-1p.html](https://www.olfer.com/olfer-cbu-da-1p.html)
...
Có. Khi chọn Fixture Profile có "Ext. Presence", "Ext. Light" hoặc "Ext. Sensors", cảm biến DALI-2 trên bus sẽ xuất hiện như Casambi sensor trong App. Bạn có thể thiết lập automation (tự bật/tắt, điều chỉnh theo ánh sáng tự nhiên) hoàn toàn trong Casambi.

**CBU-DA-1P có thể tích hợp với KNX không?**
Có, thông qua gateway KNX–Casambi (VD: VBU-K2C-W-BI). KNX gửi lệnh đến gateway, gateway dịch sang Casambi, Casambi điều khiển CBU-DA-1P và bus DALI. Tích hợp hai chiều (KNX nhận feedback từ Casambi) cũng khả thi nhưng cần cấu hình thêm.
...
> 📄 Datasheet: [olfer.com/olfer-cbu-da-1p.html](https://www.olfer.com/olfer-cbu-da-1p.html) | 🛒 [Xem sản phẩm trên KNXStore](https://knxstore.vn/products/casambi-bo-dieu-khien-dali-cbu-da-1p)

**Khi tư vấn mua hàng**, hiển thị product card:
- Tên: Olfer CBU-DA-1P – Bộ điều khiển DALI Casambi
- Mô tả: DALI master tích hợp Casambi BLE, điều khiển tối đa 50 driver, hỗ trợ DT6/DT8/TW/RGB/RGBW
- Ảnh: https://knxstore.vn/assets/image/product/casambi-bo-dieu-khien-dali-cbu-da-1p_10.jpg
- Link: https://knxstore.vn/products/casambi-bo-dieu-khien-dali-cbu-da-1p
- CTA: "Liên hệ báo giá"
...
📄 [Datasheet & Manual – Olfer CBU-DA-1P](https://www.olfer.com/olfer-cbu-da-1p.html)
📄 [Fixture Profile Reference – CBU-DA-1P](cbu-da-1p-fixture-profiles.md)
...
- Hỗ trợ kỹ thuật: knxstore.vn hoặc hotline 0918.918.755