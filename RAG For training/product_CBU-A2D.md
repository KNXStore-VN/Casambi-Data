...
> 📄 [Datasheet CBU-A2D](https://casambi.com/product/cbu-a2d/) | 🛒 [Xem sản phẩm trên KNXStore](https://knxstore.vn/products/casambi-bo-dieu-khien-2-kenh-0-10v-dali-bluetooth-cbu-a2d)

### Khi tư vấn mua hàng — render Markdown card

Fetch giá live từ `website_url` trước khi render. Format chuẩn:

```
![Casambi CBU-A2D](https://knxstore.vn/assets/image/product/casambi-bo-dieu-khien-2-kenh-0-10v-dali-bluetooth-cbu-a2d_2.jpg)
**[Casambi CBU-A2D – Bộ điều khiển 2 kênh 0-10V/DALI](https://knxstore.vn/products/casambi-bo-dieu-khien-2-kenh-0-10v-dali-bluetooth-cbu-a2d)**
Bộ điều khiển 2 kênh 0-10V/DALI tích hợp Casambi BLE, hỗ trợ TW, DALI DT8 RGB/RGBW, Standalone DALI.
💰 [GIÁ FETCH LIVE] (Giá đã bao gồm VAT) | hoặc: 💰 Liên hệ báo giá
👉 [Xem sản phẩm](https://knxstore.vn/products/casambi-bo-dieu-khien-2-kenh-0-10v-dali-bluetooth-cbu-a2d) | 📞 [Nhận báo giá](https://zalo.me/0918918755)
```
...
📄 [Datasheet – Casambi CBU-A2D](https://casambi.com/product/cbu-a2d/)
🛒 [Trang sản phẩm KNXStore](https://knxstore.vn/products/casambi-bo-dieu-khien-2-kenh-0-10v-dali-bluetooth-cbu-a2d)
